...
cloudfolderNames <- c(
                 "x264ProductLine",
                 "WgetProductLine",
                 "BerkeleyDBMemoryversionProductLine",
                 "SensorNetworkProductLine",
                 "StrategyMobileGame",
                 "TankWar",
                 "MobileMedia2",
                 "MobileGuide")
...
write.csv(x=total,file = paste(rootFolder,"timeAllLatency-1-8.csv",sep=""))

df = read.csv(file = paste(rootFolder,"timeAllLatency-1-8.csv",sep=""))
...
write.csv(x=dfsum,file = paste(rootFolder,"resultsLatency-1-8.csv",sep=""))
