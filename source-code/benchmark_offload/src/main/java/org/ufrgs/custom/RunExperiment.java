        ...
        while (!finished) {
            ...
            if (!finished && problemData != null) {
                ...
                if (offload) {
                    ...
                    // pega as configurações iniciais
                    for (boolean b : experiment_.getmFeatureModels().get(problemId)
                            .getSeed().getConfiguration()) {
                        arrayContent.put(b);
                    }
                    try {
                    ...
                    try {
                        System.out.println("Json Content: " + sendContent.toString());
                        ...
                        stringResponse = s.offload(sendContent.toString());
                        s.closeConnection();
                    ...
                    if (stringResponse != null) {
                        ...
                        try {
                            responseContent = new JSONObject(stringResponse) ;
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
