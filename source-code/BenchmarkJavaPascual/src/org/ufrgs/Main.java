...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Preferences.setBaseAlgorithm(0); // cada referente a uma posição em: ALGORITHM_NAME
        Preferences.setIndependentRuns(3);
        Preferences.setMaximumNumberOfEvaluations(40);
